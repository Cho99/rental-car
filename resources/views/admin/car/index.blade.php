...
@section('content')
    <section class="content-header">
        ...
        <div class="timeline-footer general">
            <a href="{{ route('admin.cars.create') }}" class="btn btn-primary btn general">
                <i class="fa fa-plus-square general"></i> {{ trans('car.add_car') }}
            </a>
        </div>
        <ol class="breadcrumb">
            <li>{{ trans('car.car') }}</li>
                                            ...
                                            @php($index = 1)
                                                @foreach ($cars as $car)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>{{ $car->name }}</td>
                                                        <td><img src="{{ asset('upload/car/'. $car->image) }}" alt="{{ $car->name }}" width="50px"></td>
                                                        <td class="td general">
