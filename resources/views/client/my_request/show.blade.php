                        ...
                        @elseif ($order->car->status === config('define.car.status.accept') || $order->car->status ===
                            ...
                            @elseif ($order->status === config('define.order.status.pending'))
                                <a href="{{ route('my_orders.cancel', $order->id) }}"
                                    class="btn_full_outline btn-danger">Hủy đơn</a>
                            @endif
                        @endif
                    </div>
                </aside>
                            ...
                            <div class="panel-body">
                                ...
                                <form class="review">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="comment" id="review_text" class="form-control"
                                            style="height:100px" placeholder="Hay viết bình luận"></textarea>
                                    </div>
