    ...
    <main>
        <div class="container margin_60">
                                ...
                                <a href="{{ route('cars.show', $carDiscount->id) }}">
                                    ...
                                    <div class="short_info">
                                        <i class="icon_set_1_icon-29"></i>{{ $carDiscount->seats }} Seats<span
                                            class="price">{{ $carDiscount->price }}<sup>K</sup></span>
                                    </div>
                                </a>
                            </div>
            ...
            <p class="text-center nopadding">
                <a href="#" class="btn_1 medium"><i class="icon-eye-7"></i>View all cars ({{ $numberCar }}) </a>
            </p>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="tour_container">
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="{{ asset('bower_components/car-client-lte') }}/img/tour_box_1.jpg" class="img-responsive" alt="Image">
                                <div class="short_info">
                ...
                <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.5s">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="{{ asset('bower_components/car-client-lte') }}/img/tour_box_14.jpg" width="800" height="533" class="img-responsive" alt="Image">
                                <div class="short_info">
                ...
                <div class="col-md-4 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                    <div class="tour_container">
                        ...
                        <div class="img_container">
                            <a href="single_tour.html">
                                <img src="{{ asset('bower_components/car-client-lte') }}/img/tour_box_5.jpg" width="800" height="533" class="img-responsive" alt="Image">
                                <div class="short_info">
                                    <i class="icon_set_1_icon-44"></i>Historic Buildings<span
