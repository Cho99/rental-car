                    ...
                    @elseif ($order->car->status ===  config('define.car.status.accept') || $order->car->status ===  config('define.car.status.renting'))
                        @if ($order->status === config('define.order.status.accept'))
                            ...
                            <span style="text-align: center">
                                <a style="text-align: center" class="btn_full" href="{{ route('orders.borrowed', $order->id) }}">Người thuê đã nhận xe</a>
                            </span>
                            <span style="text-align: center">
                                <a style="text-align: center" class="btn_full_outline btn-danger" href="{{ route('orders.cancel', $order->id) }}">Hủy đơn</a>
                            </span>
                        ...
                        @elseif ($order->status === config('define.order.status.borrowed'))
                            <div style="text-align: center">
                                <a style="text-align: center" class="btn_full" href="{{ route('orders.close', $order->id) }}">Kết thúc đơn</a>
                            </div>
                            <span style="text-align: center">
                                <a style="text-align: center" class="btn_full_outline btn-danger" href="{{ route('orders.cancel', $order->id) }}">Hủy đơn</a>
                            </span>
                        ...
                        @elseif ($order->status === config('define.order.status.pending'))
                            ...
                            <a class="btn_full_outline btn-danger" href="{{ route('orders.reject', $order->id) }}"></i>Từ chối</a>
                        @endif
                    @endif
                </div>
            </aside>
